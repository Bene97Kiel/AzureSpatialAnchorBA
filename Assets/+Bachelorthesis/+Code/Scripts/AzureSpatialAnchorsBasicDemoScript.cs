...
namespace Microsoft.Azure.SpatialAnchors.Unity.Examples
{
    public class AzureSpatialAnchorsBasicDemoScript : DemoScriptBase
    {
        ...
        public Vector3 PositionOfObjetInRelationToAnchor = new Vector3(0, 0, 0);
        protected override void OnCloudAnchorLocated(AnchorLocatedEventArgs args)
        {
            ...
            if (args.Status == LocateAnchorStatus.Located)
            {
                ...
                UnityDispatcher.InvokeOnAppThread(() =>
                {
                    ...
                    Debug.Log(anchorPose.position + " my position");
                    GameObject.FindGameObjectWithTag("DefaultPrefab").GetComponent<MeshRenderer>().enabled = false;

                    ARContent.transform.position = anchorPose.position + PositionOfObjetInRelationToAnchor;
